...
export default function App() {
  ...
  }, [params.levelThree, colorValue, sizeValue, priceValue, discountValue, sortValue, stock, pageNumber]);
              ...
              <form className="mt-4 border-b border-gray-200">
                ...
                {singleFilter.map((section) => (
                  <Disclosure key={section.id} as="div" className="border-b border-gray-200 py-6 px-4">
                    <h3 className="-mx-2 -my-3 flow-root">
                      <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 px-2 text-gray-400 hover:text-gray-500">
                        <span className="font-medium text-gray-900">{section.name}</span>
                        <span className="ml-6 flex items-center">
                          <PlusIcon aria-hidden="true" className="size-5 group-data-[open]:hidden" />
                          <MinusIcon aria-hidden="true" className="size-5 group-[&:not([data-open])]:hidden" />
                    ...
                    <DisclosurePanel className="pt-6">
                      <div className="space-y-6 max-w-max">
                        {section.options.map((option, optionIdx) => (
                          <label
                            key={option.value}
                            htmlFor={`singlefilter-${section.id}-${optionIdx}`}
                          ...
                          >
                            <div className="relative">
                              ...
                              />
                              <div className="h-4 w-4 rounded-full border border-gray-300 bg-white peer-checked:border-indigo-600 peer-checked:bg-indigo-600 peer-focus:outline peer-focus:outline-2 peer-focus:outline-offset-2 peer-focus:outline-indigo-600"></div>
                            </div>
